class BootstrapData < ActiveRecord::Migration
  def self.up
    ...
    execute "INSERT INTO `property_types` VALUES (1,'Two Star Hotel','Minimal comfort, but commands the second highest hotel price.',2300,0,'2005-07-23 22:45:00','2005-07-23 22:55:22',200,20,2000,20,2),(2,'Cheap Hotel','Cheapest of the hotels. Roaches stay for free.',1200,0,'2005-07-23 22:50:00','2005-07-23 22:55:46',100,15,1000,10,1),(3,'Three Star Hotel','What most people expect out of a hotel. Coordinated pastel scenes above color coordinated beds.',3600,0,'2005-07-23 22:53:00','2005-07-23 22:55:03',300,25,3000,30,3),(4,'Super Insane Hotel','Perfection all around, this hotel commands the highest prices at the highest levels.',33000,0,NULL,NULL,900,30,36000,40,4);"
    execute "INSERT INTO `square_types` VALUES (1,'Game Owned',0,'2005-07-23 22:56:00','2005-07-23 22:56:55'),(2,'Player Owned',0,'2005-07-23 22:56:00','2005-07-23 22:57:07'),(3,'Empty, Buyable',1,'2005-07-23 22:57:00','2005-07-23 22:57:19'),(4,'Dead Space',0,'2005-07-23 22:57:00','2005-07-23 22:57:33'),(5,'Quicky',0,NULL,NULL);"
  end
